...
document.getElementById("readmore-section").addEventListener("toggle", function() {
    const imgContainer = document.getElementById("dynamic-image");

    if (this.open) {
        imgContainer.innerHTML = '<img src="slike/nacrtovanje_inzeniring.jpg" alt="Načrtovanje in inženiring">';
    } else {
        imgContainer.innerHTML = ''; // odstrani sliko, ko zapreš
    }
});
